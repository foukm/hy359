...
<html lang="en" class="no-js">
    ...
    <body onload="checkCookiesForTheUser();start();showExtra();mapB();return false;">
        <div id="fb-root"></div>
        ...
        <div class="row">
            ...
            <div class="column column1Width" id="choices" style="background-color:#ADD8E6;">           
                ...
                <button class="button" onclick="window.location.href='keeper.jsp'">Keeper Login</button>
                <button class="button" onclick="window.location.href='owner.jsp'">Owner Login</button>
            ...
            <div class="column column2Width" id="output" style="background-color:#fffff0;">
                ...
                <div id="ajaxContent">
                    <form  name="myForm" id="myForm" class="grid grid-3" style="display: none;">
                        <input type="hidden" id="keeper_id" value="">
                    <div class="row">
                        <div class="col-25">
                   ...
                   <div class="row">
                    ...
                    <div id="control"  >
                        <div class="row">
                            <div class="col-25">
                            <label for="property" class="required">Διαμονή κατοικιδίου</label>
                            </div>
                            <div class="col-75">
                                <select  name="property" id="property" required  onchange="showExtraInfoCat()" disabled="disabled">
                                <option value="">Επέλεξε</option>
                        ...
                        <div class="row">
                            <div class="col-25">
                            <label  class="required">Φιλοξενώ</label>
                            </div>
                            <div class="col-75">
                                <input type="checkbox" id="catkeeper" name="catkeeper" value="true" onclick="priceCarPerNight()"  disabled="disabled">
                                <label for="catkeeper"> Γάτα </label><br>
                                <input type="checkbox" id="dogkeeper" name="dogkeeper" value="true" onclick="priceDogPerNight()"  disabled="disabled">
                                <label for="dogkeeper"> Σκύλο </label><br>
                            </div>
                        </div>
                        <div id="catS" style="display:none">
                            <div class="row">
                                <div class="col-25">
                                <label for="catprice" class="required" > Τιμή φιλοξενίας για γάτα ένα βράδυ</label>
                                </div>
                                <div class="col-75">
                                    <input type="number" name="catprice" id="catprice" min="0" max="15"  disabled="disabled">
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="dogS" style="display:none">
                            <div class="row">
                                <div class="col-25">
                                <label for="dogprice" class="required" >Τιμή φιλοξενίας για σκύλο ένα βράδυ</label>
                                </div>
                                <div class="col-75">
                                    <input type="number" name="dogprice" id="dogprice" min="0" max="20"  disabled="disabled">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-25">
                            <label for="propertydescription" class="required">Περιγραφή κατοικίας</label>
                            </div>
                            <div class="col-75">
                                <textarea id="propertydescription" name="propertydescription" rows="4" cols="50"  disabled="disabled"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <button type="button"  onclick="sendEditAJAX(); return false;" value="Edit">Edit</button>                 
                ...
                <div>
                <a>Take care for </a>
                <form name="gptdefault" onsubmit="questionGPT(); return false;" id="gptdefault">
                <label for="forGPT">a:</label>
                <input type="text" id="forGPT" name="forGPT">
                <input type="submit">
                </form>
                <div id="answerGPT">
                ...
                <div>
                <a>Information for  </a>
                <form name="gptdefaultbreed" onsubmit="questionGPTbreed(); return false;" id="gptdefaultbreed">
                <label for="breed">a breed:</label>
                ...
                <br><br><!-- comment -->
                <h4>Statistics</h4>
                <button type="submit" id="sumOfBooking" class="button" onclick="seeSumOfBookings();return false;" value="Sum of bookings">See of bookings</button>
                <div id="sumOfBookings"></div>
                <button type="submit" id="sumOfDaysBooking" class="button" onclick="seeSumOfDaysBookings();return false;" value="Sum days of bookings">See of bookings</button>
                <div id="sumOfDaysBookings"></div>
                <button type="submit" id="seeReviews" class="button" onclick="seeReviews();return false;" value="See review">See Reviews</button>
                <div id="reviews"></div>
                
                <div>
                <a>Messages</a>
                <form name="messageForm" onsubmit="sendAmessage(); return false;" id="messageForm">
                <label for="message">Message to the owner</label>
                <input type="text" id="breed" name="message">
                <input type="submit">
                </form>
                <div id="answerbreed">    
                </div>
