    ...
    <body onload="checkCookiesForTheUser();start();showExtra();mapB();return false;">
        ...
        <div class="row">
            ...
            <div class="column column2Width" id="output" style="background-color:#fffff0;">
                ...
                <button type="submit" id="sumOfDaysBooking" class="button" onclick="seeSumOfDaysBookings();return false;" value="Sum days of bookings">Sum days of bookings</button>
                ...
                <div id="hasRequest" style="display: none;">
                    <h3>You have a request</h3>
                    <button  class="button" id="accB" onclick="acceptReq()">Accept</button>
                    <button  class="button" id="rejB" onclick="rejectRed()">Reject</button>       
                </div>
            </div>
